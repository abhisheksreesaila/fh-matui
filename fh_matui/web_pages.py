...
# %% auto #0
__all__ = ['SECTION_STYLE', 'SECTION_MARGIN', 'STANDARD_FOOTER_COLUMNS', 'LandingPage', 'HeroSection', 'FeatureShowcase',
           'FeaturesGrid', 'PricingSection', 'FAQSection', 'PageFooter', 'LandingNavBar', 'LandingPageSimple',
           'MarkdownSection', 'ContentPage']
...
def LandingPageSimple(
    ...
    # 2. Benefits (optional) - FeatureShowcase with bento image cards
    if benefits:
        ...
        main_sections.append(Section(benefits_section, id="benefits", cls=SECTION_STYLE))
    
    # 3. Features (optional) - FeaturesGrid with icon cards
    if features:
        main_sections.append(_SectionWave())
        ...
        main_sections.append(Section(features_section, id="features", cls=SECTION_STYLE))
    ...
    if pricing_plans:
        ...
        main_sections.append(Section(pricing_section, id="pricing", cls=SECTION_STYLE))
    ...
    if faqs:
        ...
        main_sections.append(Section(faq_section, id="faq", cls=SECTION_STYLE))
    ...
    return Div(
        ...
        navbar,
        Main(*main_sections, cls="max"),
        footer,
        cls=f"column {cls}".strip(),
    )

# Compatibility alias
LandingPage = LandingPageSimple
