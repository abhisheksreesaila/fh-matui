...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'fh_matui.app_pages': { 'fh_matui.app_pages.LoginScreen': ('app_pages.html#loginscreen', 'fh_matui/app_pages.py'),
                                    'fh_matui.app_pages.TopContent': ('app_pages.html#topcontent', 'fh_matui/app_pages.py'),
                                    'fh_matui.app_pages.TopLayout': ('app_pages.html#toplayout', 'fh_matui/app_pages.py')},
            'fh_matui.billing': { 'fh_matui.billing.BillingStatusCard': ('billing.html#billingstatuscard', 'fh_matui/billing.py'),
                                  'fh_matui.billing.CheckoutCard': ('billing.html#checkoutcard', 'fh_matui/billing.py'),
                                  'fh_matui.billing.TrialBanner': ('billing.html#trialbanner', 'fh_matui/billing.py'),
                                  'fh_matui.billing._calc_savings_pct': ('billing.html#_calc_savings_pct', 'fh_matui/billing.py'),
                                  'fh_matui.billing._checkout_toggle_css': ('billing.html#_checkout_toggle_css', 'fh_matui/billing.py'),
                                  'fh_matui.billing._checkout_toggle_js': ('billing.html#_checkout_toggle_js', 'fh_matui/billing.py')},
