...
```html
<article class="small-width small-height scroll" style="padding-top: var(--header-height, 64px);">
  <header class="fixed bold" style="top:0; z-index:10;">Fixed header</header>
  <p>
